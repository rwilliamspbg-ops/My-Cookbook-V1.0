...
const dbPath = path.join(process.cwd(), 'data', 'recipes.db'); // adjust if needed
const db = new Database(dbPath);

// Example schema assumption: recipes(id, title, description, ingredientsJson, instructionsJson, prepTime, cookTime, servings, category)
