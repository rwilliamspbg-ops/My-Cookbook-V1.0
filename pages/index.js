                ...
                <div key={recipe.id} className="recipe-card">
                  ...
                  {(recipe.prepTime || recipe.cookTime || recipe.servings) && (
                    <div className="recipe-meta">
                      {recipe.prepTime && <span className="meta-item">⏱️ Prep: {recipe.prepTime}</span>}
                      {recipe.cookTime && <span className="meta-item">🔥 Cook: {recipe.cookTime}</span>}
                      {recipe.servings && <span className="meta-item">🍽️ Serves: {recipe.servings}</span>}
                    </div>
                  )}
